...
//Date provided below stands for Oct. 19, 2021. 0=January so 9=October. The date can be changed to show a different schedule of events.  var thisDate = new Date(2021, 9, 19); When the parameter value is not provided, the date changes to the system/current date.
...
/* The getEvent() function returns the HTML code for the daily events at the union given a day number ranging from 0 (Sunday) to 6 (Saturday). */
